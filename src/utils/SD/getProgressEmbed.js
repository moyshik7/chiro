const { EmbedBuilder, AttachmentBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, User, Colors } = require("discord.js");
 ...
 */
module.exports = async (user, context = "", addCancelButton = true, quote) => {
    let data;
    ...
    if (data.current_image == null) { // Make better later
        ...
        return {content: `*'${quote}'*`, embeds: [embed]};
    }
